...
class _ChatScreenState extends State<ChatScreen> {
  ...
  static const apiKey = "AIzaSyDRsGaMpqpBGQ3FnIt9koYtySjnZ_exM_c";
  ...
  Future<void> sendMessage() async {
    ...
    // Gửi tin nhắn đến chatbot và đợi phản hồi
    final content = [Content.text(message)];
    final response = await model.generateContent(content);
    setState(() {
      // chatbot phản hồi tin nhắn
                  ...
                  Expanded(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        label: const Text("Nhập tin nhắn"),
                      ),
                    ),
                  ),
                  const Spacer(),
